...
def test_get_guest_list_returns_data(client, sample_service_guest_list):
    ...
    response = client.get(f'service/{service_id}/guest-list', headers=[create_service_authorization_header()])
...
def test_get_guest_list_404s_with_unknown_service_id(client):
    ...
    response = client.get(path, headers=[create_service_authorization_header()])
